...
class AIService {
    ...
    async processWhatsAppMessage(message, userContext) {
        try {
...
For other requests, provide helpful responses.`;
    ...
    async generateTransferConfirmation(amount, targetAmount, recipientPhone, exchangeRate, fee) {
        try {
...
Apakah Anda yakin ingin melanjutkan? / Are you sure you want to proceed?`;
    ...
    async generateKYCGuidance(step) {
        try {
