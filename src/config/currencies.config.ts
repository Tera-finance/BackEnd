...
export const MASTERCARD_CURRENCIES: Currency[] = [
...
export const WALLET_CURRENCIES: Currency[] = [
...
export const RECIPIENT_CURRENCIES: Currency[] = [
  // Asia Pacific
...
// Mock token mapping
export const MOCK_TOKEN_MAPPING: Record<string, string> = {
  'USD': 'mockUSDC',
  'EUR': 'mockEUROC',
  'CNY': 'mockCNHT',
  'JPY': 'mockJPYC',
...
export const MOCK_TOKEN_POLICIES: Record<string, string> = {
...
export function hasMockToken(currencyCode: string): boolean {
  return currencyCode in MOCK_TOKEN_MAPPING;
}

export function getMockToken(currencyCode: string): string | null {
  return MOCK_TOKEN_MAPPING[currencyCode] || null;
}

export function getPolicyId(mockToken: string): string | null {
